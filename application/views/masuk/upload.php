    ...
    <div class="row">
    	<div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?= base_url().'masuk/up' ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="upload btn btn-info"><i class="fa fa-upload"></i> Upload</button>
